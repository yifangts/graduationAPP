<template>
	<div>
        <mt-header title="动物" fixed>
            <router-link to="/animal" slot="left" v-show="panelClick.count!=0">
        ...
        <div class="content" v-show="panelClick.count!=1">
            <my-panel :panelArray=aniExperiments :panelClick=panelClick></my-panel>
        </div>
	</div>
</template>
<script>
